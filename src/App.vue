  ...
  <div class="min-h-screen flex flex-col bg-gray-50">
    ...
    <main class="flex-grow flex justify-center items-start py-8">
      <div class="container mx-auto px-4 max-w-7xl w-full">
        ...
        <!-- Categories section -->
        <section class="mb-8">
          <h2 class="text-xl font-bold mb-4">Kategoriyalar</h2>
        ...
        <section class="mb-8">
          <div class="flex justify-between items-center mb-4">
            <h2 class="text-xl font-bold">Ommabop mahsulotlar</h2>
            <a href="#" class="text-purple-600 hover:text-purple-700">Barchasini ko'rish</a>
          </div>
        ...
        <section class="mb-8">
          <div class="flex justify-between items-center mb-4">
            <h2 class="text-xl font-bold">Yangi mahsulotlar</h2>
            <a href="#" class="text-purple-600 hover:text-purple-700">Barchasini ko'rish</a>
          </div>
          <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            <ProductCard 
